          ...
          <div class="row">
            <div class="col-md-6">
              <div class="m-5 text-center">
                <h1>Inicio de Sesion <br> (Alumno)</h1>
              </div>
              <form class="m-5" action="controlador/control_alumno.php" method="post" name="login">
                <div class="mb-3">
                ...
                <br>
                <div>
                  <label>Si eres docente o administrador,<br> ingresa este enlace...</label><br><br>
                  <a href="index.php"> Docente o Administrador </a>
                </div>
              </form>
            </div>
            <div class="col-md-6">
